...
<body>
    <div class="container">
        <div class="image">
            <img src="<?php echo e(URL::asset('/3e9a7e17e13da18d7c8bd995e595b3bb-removebg-preview.png')); ?>" alt="">
        </div>
        ...
        <div class="su">
            ...
            <form id="loginForm" action="<?php echo e(route('login')); ?>" method="POST" style="display: none;">
    ...
    <script src="<?php echo e(URL::asset('/signup.js')); ?>"></script>
</body>
